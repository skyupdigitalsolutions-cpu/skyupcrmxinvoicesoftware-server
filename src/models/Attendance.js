...
// Captured device coordinates at clock-in / clock-out (where the employee
// actually was), separate from the admin-configured geofence. accuracy is the
// GPS reading's radius in metres, when the device reports it.
...
const attendanceSchema = new mongoose.Schema({
    ...
    // Where the employee physically clocked in / out (captured from the device).
    loginLocation: { type: geoPointSchema, default: null },
    logoutLocation: { type: geoPointSchema, default: null },
